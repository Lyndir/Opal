...
public abstract class WicketUtils {
     ...
     * @param key
     *            The localization key that provides the locale-specific value. The value may be a
     *            {@link MessageFormat#format(Object)}-string. In this case, the args will be used to fill in variables.
     * @param args
     *            The arguments that contain the data to fill into the locale-specific format specification.
     * 
