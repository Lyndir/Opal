...
/**
 * <h2>{@link GenericBorder}<br> <sub>[in short] (TODO).</sub></h2>
 *
 * <p> <i>Jan 18, 2010</i> </p>
 *
 ...
 * @author lhunath
 */
public class GenericBorder<T> extends Border {

    /**
     * Create a new {@link GenericBorder} instance.
     *
     * @param id    The component's wicket ID.
     * @param model The component's model.
     */
    public GenericBorder(final String id, final IModel<T> model) {
